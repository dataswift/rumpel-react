...
describe.only('query parameters', () => {
  ...
  it('should return the correct value when one parameter has nested query parameter', () => {
    // @ts-ignore
    global.window = Object.create(window);
    const search = "?application_id=testapp&fallback=https://fallback.com&redirect_uri=https://docs.dataswift.io%3Fredirect=https://nested-redirect.com";
    Object.defineProperty(window, "location", {
      value: {
        search: search
      },
  ...
  it('should return the correct value when parameter have hashes', () => {
    // @ts-ignore
    global.window = Object.create(window);
    const search = "?application_id=testapp&fallback=https://testing.hubat.net/#/feed&redirect_uri=https://docs.dataswift.io%3Fredirect=https://testing.hubat.net/#/feed";
    Object.defineProperty(window, "location", {
      value: {
        search: search
      },
  ...
  it('should return the correct value when url hashes are encoded', () => {
    // @ts-ignore
    global.window = Object.create(window);
    const search = "?application_id=testapp&fallback=https://testing.hubat.net/%23/feed&redirect_uri=https://docs.dataswift.io%3Fredirect=https://testing.hubat.net/%23/feed";
    Object.defineProperty(window, "location", {
      value: {
        search: search
      },
