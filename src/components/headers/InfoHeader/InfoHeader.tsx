    ...
    <>
      ...
      <Modal open={openDialog} onClose={() => setOpenDialog(false)}>
        <div className="rum-modal-header">
          <div className={'rum-modal-text-title'}>
            What is HAT?
          </div>
        </div>
        <div className="rum-modal-body rum-modal-text-content">
          <div>
            ...
            <div>
              A HAT is a micro-server data account. It can enable you to claim
              data from the Internet, as well as store, process, use, and exchange that data with others.
              <br /> <br />
              It is also a private space for creating new data through machine learning and analytics,
              enabling you to share insights about yourself.
              <br /> <br />
              It is also a private space for creating new data through machine learning and analytics,
              enabling you to share insights about yourself.
            </div>
