...
export const InfoHeader: React.FC<Props> = ({ fixed, hideMobile }) => {
  ...
  return (
    <>
      <header
        className={`app-header ${fixed ? 'app-header-fixed' : ''} ${
          hideMobile ? 'app-header-hide-mobile' : ''
        }`}
      >
        ...
        <div className="rum-modal-body rum-modal-text-content">
          <div>
            ...
            <div>
              ...
              <br /> <br />
              The HAT PDA also replaces the need for user accounts on mobile apps and websites. It
              is already referenced globally as a best in class solution on the Internet for
              individual data ownership and rights.
              <br /> <br />
              The HAT Personal Data Account technology is more than just a centralised bank account
              technology. It is a decentralised private microserver for creating new data through
